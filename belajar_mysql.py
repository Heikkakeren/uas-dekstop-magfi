...
label_email_login = tk.Label(login_window, text="Email", font=("Arial", 12), bg='#FFB6C1')
...
label_password_login = tk.Label(login_window, text="Password", font=("Arial", 12), bg='#FFB6C1')
...
btn_login = tk.Button(login_window, text="Login", command=login, font=("Arial", 14), bg='#90EE90', fg='white')
...
main_window.configure(bg='#90EE90')
main_window.withdraw()  # Sembunyikan jendela utama pada awalnya

input_frame = tk.Frame(main_window, bg='#90EE90')
